...
exports.imageUpload = async (req, res) => {
    try{
        ...
        const filee = String(file.name);
        const fileType=filee.split('.')[1]
        ...
        const response = await uploadFileToCloudinary(file, "xyz");
    ...
    try{
        ...
        const file = req.files.videoFile;
         ...
         const supportedTypes = ["mp4", "mov"];
          const filee = String(file.name);
        const fileType=filee.split('.')[1].toLocaleLowerCase()
         console.log("File Type:", fileType);
